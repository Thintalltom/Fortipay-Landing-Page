  ...
  return (
    <section className="px-[64px] py-[120px]">
        ...
        <div className=' mb-[30px]  max-w-[1280px] h-[410px] border-[1px] border-[#33B7FF] mx-auto flex justify-center flex-col items-center  rounded-[24px] bg-[#EBF8FF]'>
           <p className="text-[38px] text-[#0259cc] font-[Manrope] font-medium">Get Started with Corvyn AI</p>
        ...
        <div className="flex gap-[20px]">
            <button className='bg-[#0259cc] text-white font-[Lato] min-w-[180px] max-w-[185px] font-normal text-[16px] py-[10px] px-[20px] rounded-[40px]'>Get Started</button>
                    <button className='border-[#33B7FF]  border-[1px] text-[#0259cc] font-[Lato] min-w-[180px] max-w-[185px] font-normal text-[16px] py-[10px] px-[20px] rounded-[40px]'>Request a Demo</button>
        </div>
        </div>
    </section>
  )
